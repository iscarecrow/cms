...
import vanillaColorPicker from '../plugin/medium-editor/vanilla-color-picker';

let cmsEditorInit = function() {
  /**
   * Custom `color picker` extension
   */
  MediumEditor.ColorPickerExtension = MediumEditor.extensions.button.extend({
    name: "colorPicker",
  ...
  // 富文本编辑
  let editor = new MediumEditor('#container', {
    toolbar: {
